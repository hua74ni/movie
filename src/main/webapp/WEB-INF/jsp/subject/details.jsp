                                ...
                                <c:forEach items="${comments}" var="comment">
                                    <div class="comment-list">
                                        <div class="list-title">
                                            ...
                                            <%--<div class="pull-left allstar" style="line-height: 16px;margin-left: 10px;color: orange;">${comment.rating} 分</div>--%>
                                            ...
                                            <div class="pull-left gray">${comment.submitDate}
                                                <mv:securityTag userId="${comment.userId}">
                                                    &nbsp;&nbsp;&nbsp;
                                                    <button type="button" class="close  btn-danger delete_comment" style="line-height: 16px;"
